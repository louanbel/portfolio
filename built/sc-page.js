jQuery(function () {
    ...
    typewriter
        .pauseFor(750)
        .typeString(`class <span class="jaune">Louan</span> <span class="bleu">{</span><br /><span class="ligne">String <span class="gris">job</span> = <span class="bleu">"</span><span class="vert">Développeur web</span><span class="bleu">";</span></span><br /><span class="ligne">int <span class="gris">âge</span> = <span class="rouge">${getAge()}</span><span class="bleu">;</span></span><br /><span class="ligne bool">boolean <span class="gris">estVéhiculé</span> = <span class="rouge">true</span><span class="bleu">;</span></span><br /><span class="ligne outilsdiv"><span class="outils">String<span class="bleu">[]</span> <span class="gris">autresLangues</span> = </span><div class="te" onclick="openBubble(this, 'normal')"><img width="50" src="image/anglais.png" alt="anglais" title="anglais"><p>Avancé</p></div><div class="te" onclick="openBubble(this, 'normal')"><img width="50" src="image/espagnol.png" alt="Espagnol" title="Espagnol"><p>Notions</p></div><span class="bleu">;</span></span><br /><span class="ligne">String<span class="bleu">[]</span> <span class="gris">passions</span> = <span class="bleu">{"</span><span class="vert">Voile</span><span class="bleu">", "</span><span class="vert">Entrepreneuriat</span><span class="bleu">", "</span><span class="vert">Nouvelles technologies</span><span class="bleu">", "</span><span class="vert">Exploration spatiale</span><span class="bleu">"};</span><br/><span class="bleu">}</span>`)
        .start();
    ...
    function dragElement(elem) {
        ...
        function closeDragElement() {
            ...
            if (elem.offsetLeft - elem.scrollLeft - elem.offsetWidth * 0.5 <
                0 /* gauche */ ||
